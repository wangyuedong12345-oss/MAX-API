...
func SetApiRouter(router *gin.Engine) {
	router.GET("/health", middleware.PublicStatusRateLimit(), controller.GetHealth)
	router.GET("/health/live", middleware.PublicStatusRateLimit(), controller.GetHealthLive)
	router.GET("/health/ready", middleware.PublicStatusRateLimit(), controller.GetHealthReady)
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/zeroframe/models", middleware.TokenAuth(), controller.GetZeroFrameModels)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/aff_transfer", middleware.CriticalRateLimit(), middleware.UserCriticalRateLimit(), controller.TransferAffQuota)
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.PUT("/tiered_billing", controller.UpdateTieredBillingConfig)
		...
		logRoute.GET("/self/detail/:id", middleware.UserAuth(), controller.GetUserLogDetail)
		logRoute.DELETE("/", middleware.AdminAuth(), controller.DeleteOldLogsCompat)

		systemTaskRoute := apiRouter.Group("/system-task")
		systemTaskRoute.POST("/log-cleanup", middleware.AdminAuth(), controller.CreateLogCleanupSystemTask)
		systemTaskRoute.GET("/log-cleanup/current", middleware.AdminAuth(), controller.GetCurrentLogCleanupSystemTask)
		systemTaskRoute.GET("/log-cleanup/:task_id", middleware.AdminAuth(), controller.GetLogCleanupSystemTask)
