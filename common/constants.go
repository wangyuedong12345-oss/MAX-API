...
func NormalizeLogo(logo string) string {
	...
	if logo == "" || logo == LegacyDefaultLogo {
		return DefaultLogo
	}
	return logo
}
...
// SetTheme is kept for configuration compatibility. Only the default frontend is supported.
func SetTheme(_ string) {
}

// ThemeAwarePath rewrites legacy /console/* paths to their default frontend equivalents.
...
var LogRequestContentEnabled = false
var LogResponseContentEnabled = false
var LogContentMaxCharacters = 12000
...
var RetryTimes = 0
var EmptyCompletionRetryEnabled = false
